...
internal class ExposedTableGenerator(
    ...
    private fun FileSpec.Builder.generateTableFunctions(
        ...
        addFunction("updateCrud") {
            receiver(tableClassName)
            addParameter("dto", tableDeclaration.fullInterfaceClassName)
            addCodeBlock {
                beginControlFlow("$tableName.update")
                addStatement("it.fromCrud(dto)")
                endControlFlow()
            }
        }
